...
You can also embed plots like this dot-and-whisker plot [see @Solt2015c]:

```{r dotwhisker_plot, fig.width = 7, fig.height = 4, warning = FALSE, message = FALSE, echo=FALSE}
